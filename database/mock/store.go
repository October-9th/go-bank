...
// Source: github.com/October-9th/simple-bank/database/sqlc (interfaces: Store)
...
import (
	...
	sqlc "github.com/October-9th/simple-bank/database/sqlc"
...
// GetAccountForUpdated mocks base method.
func (m *MockStore) GetAccountForUpdated(arg0 context.Context, arg1 int64) (sqlc.Account, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccountForUpdated", arg0, arg1)
	ret0, _ := ret[0].(sqlc.Account)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAccountForUpdated indicates an expected call of GetAccountForUpdated.
func (mr *MockStoreMockRecorder) GetAccountForUpdated(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccountForUpdated", reflect.TypeOf((*MockStore)(nil).GetAccountForUpdated), arg0, arg1)
}
